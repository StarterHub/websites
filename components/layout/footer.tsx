...
export default function Footer(props: LngProps) {
  ...
  return (
    <div className="absolute w-full py-5 text-center">
      ...
      {/*    href="https://github.com/StarterHub/websites"*/}
      {/*    target="_blank"*/}
      ...
      <span className="mt-2 flex flex-wrap items-center justify-center text-sm text-gray-500 dark:text-gray-400 sm:text-center">
        ...
        <a
          href="https://www.kjxbyz.com/starter-projects"
        ...
        {process.env.VERCEL_GIT_COMMIT_SHA && (
          <p className="flex items-center justify-center">
            <a
              href={`https://github.com/StarterHub/websites/commit/${process.env.VERCEL_GIT_COMMIT_SHA}`}
              target="_blank"
              className="hover:underline"
              rel="noreferrer"
            >
        ...
        &nbsp;
        <Image
          src="https://visitor-badge.laobi.icu/badge?page_id=starter-projects.kjxbyz.com"
          width={60}
          height={20}
          alt="visitor badge"
        />
